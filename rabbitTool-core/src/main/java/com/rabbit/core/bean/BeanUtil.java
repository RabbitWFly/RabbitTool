...
import com.rabbit.core.bean.BeanDesc.PropDesc;
import com.rabbit.core.bean.copier.BeanCopier;
import com.rabbit.core.bean.copier.CopyOptions;
import com.rabbit.core.bean.copier.ValueProvider;
import com.rabbit.core.collection.CollUtil;
import com.rabbit.core.convert.Convert;
import com.rabbit.core.lang.Editor;
import com.rabbit.core.lang.Filter;
import com.rabbit.core.map.CaseInsensitiveMap;
import com.rabbit.core.map.MapUtil;
import com.rabbit.core.util.ArrayUtil;
import com.rabbit.core.util.ClassUtil;
...
public class BeanUtil {
	 ...
	 * 如果isSimple为{@code false}，则只匹配类名而忽略包名，例如：com.rabbit.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code true}，则匹配包括包名的全类名，例如：com.rabbit.TestEntity匹配com.rabbit.TestEntity
	 *
	 * @param bean          Bean
